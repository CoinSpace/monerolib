...
describe('ringct', () => {
  ...
  describe('ecdhDecode', () => {
    ...
    it('should work for v1', () => {
      ...
      },  hexToBuffer('e720a09f2e3a0bbf4e4ba7ad93653bb296885510121f806acb2a5f9168fafa01'), ringct.RCTTypes.Bulletproof),
      {
    ...
    it('should work for v2', () => {
      assert.deepStrictEqual(ringct.ecdhDecode({
        amount: hexToBuffer('e745cf6a1fe5f04a', 8),
      },  hexToBuffer('ce0ae31063ed7d5f87db7a312b99cadd77786cd366970e3d82e4735a2d65ce05'), ringct.RCTTypes.Bulletproof2),
      {
  ...
  describe('pedersenCommitment', () => {
    it('should work', () => {
      assert.strictEqual(ringct.pedersenCommitment(
        hexToBuffer('c32eac9cec686d5c9b1397d31ce8f2e5d8ccdba118724ef332da1e9854af9a0a'),
        hexToBuffer('0f78b8c44cc7eef45371b2faea30871552f0d74be195720f0ff9395d302a7a05')
  ...
  describe('decodeRct', () => {
    it('should work', () => {
      const result = ringct.decodeRct(
        { amount: hexToBuffer('e745cf6a1fe5f04a', 8) },
        hexToBuffer('59ef441cbb7f79d814f763a40d2c6a30a3c7f6ee340859711243a12e460cbf8b'),
        ringct.RCTTypes.CLSAG,
        0,
        hexToBuffer('c21ac180b9702ffb85930724a28698ebf2a196bcc8ee205b159c5755f3b32a69')
      );
      ...
      const result2 = ringct.decodeRct(
        { amount: hexToBuffer('6d5b3047f314a32e', 8) },
        hexToBuffer('b3330c0eeccd033e4f417f858b63dada88a629148ba2bc26d214f1d29b89353b'),
        ringct.RCTTypes.CLSAG,
        1,
        hexToBuffer('5c673fbe576152ce517dc463a7b9db68fcd21117a46b4ee9e4cd34b44d0a8b98')
      );
