...
/**
 * @typedef {object} OutputOpening
 * @property {bigint} amount
 * @property {bigint} mask
 */

/**
 * @typedef {object} BulletproofPlusResult
 * @property {import('./raw.js').BulletproofPlus} proof
 ...
 *
 * @param {OutputOpening[]} outputs
 * @returns {BulletproofPlusResult} proof + commitments
 */
