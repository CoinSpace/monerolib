...
export function parseTxExtra(buf) {
  ...
  return txExtra.decode(buf).reduce((acc, { tag, data }) => {
    ...
    } else if (tag === TX_EXTRA_TAG_ADDITIONAL_PUBKEYS && !acc.additionalPublicKeys.length) {
    ...
    txPublicKeys: [], additionalPublicKeys: [], encryptedPaymentId: undefined,
  }));
}
...
export function prepareTransaction({
  ...
  const generated = generateOutputs(destinations, txSecretKey, secretViewKey);
