 ...
 * calculate_transaction_hash: https://github.com/monero-project/monero/blob/v0.18.5.0/src/cryptonote_basic/cryptonote_format_utils.cpp#L138-L175
 *
 ...
 * sort_tx_extra: https://github.com/monero-project/monero/blob/v0.18.5.0/src/cryptonote_basic/cryptonote_format_utils.cpp#L603-L664
 * tx_extra tags: https://github.com/monero-project/monero/blob/v0.18.5.0/src/cryptonote_basic/tx_extra.h#L34-L45
 *
 ...
 *
 * tags: https://github.com/monero-project/monero/blob/v0.18.5.0/src/cryptonote_basic/tx_extra.h#L34-L45
...
export function parseTxExtra(buf) {
  ...
  // get_encrypted_payment_id_from_tx_extra_nonce: https://github.com/monero-project/monero/blob/v0.18.5.0/src/cryptonote_basic/cryptonote_format_utils.cpp#L830-L838
...
export function getPreMlsagHash(prefixHash, rctSigBase, bulletproofPlus) {
  ...
  const bp = bulletproofPlus;
  const bpHash = fastHash(concatBytes(bp.A, bp.A1, bp.B, bp.r1, bp.s1, bp.d1, ...bp.L, ...bp.R));
 ...
 * construct_tx_with_tx_key: https://github.com/monero-project/monero/blob/v0.18.5.0/src/cryptonote_core/cryptonote_tx_utils.cpp#L415-L468
 * generate_output_ephemeral_keys: https://github.com/monero-project/monero/blob/v0.18.5.0/src/device/device_default.cpp#L294-L352
 *
 ...
 * construct_tx_with_tx_key: https://github.com/monero-project/monero/blob/v0.18.5.0/src/cryptonote_core/cryptonote_tx_utils.cpp#L241-L651
 * genRctSimple: https://github.com/monero-project/monero/blob/v0.18.5.0/src/ringct/rctSigs.cpp#L1105-L1293
 *
