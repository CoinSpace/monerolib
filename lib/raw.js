...
import { assertUint64, isKnownRctType, isV2EcdhType } from './helpers.js';
 ...
 * @property {number} type - one of RCTTypes
 * @property {bigint} txnFee
 * @property {Uint8Array[]} ecdhInfo - per-output encrypted amounts (8 bytes each for v2)
 ...
 * @property {import('./bulletproofs.js').BulletproofPlus[]} bulletproofsPlus
 * @property {{ s: Uint8Array[], c1: Uint8Array, D: Uint8Array }[]} CLSAGs
 * @property {Uint8Array[]} pseudoOuts
 */

/**
 * @typedef {object} Transaction - a decoded RingCT (v2) transaction
 * @property {TxPrefix} prefix
 * @property {RctSigBase} rctSigBase
 * @property {RctSigPrunable} rctSigPrunable
 */
