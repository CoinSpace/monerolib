...
import { Fn, Point, hashToEc, hashToScalar, randomScalar } from './crypto-util.js';
...
// TODO refactor: the decodeInt(hashToScalar(...)) / decodeInt(randomScalar()) pattern duplicates
// bulletproofs' hs/rand helpers — hoist to a shared helper.
...
export function proveClsag(message, pubs, inSk, a, Cout, index) {
  ...
  const z = Fn.sub(decodeInt(inSk.mask), decodeInt(a));
