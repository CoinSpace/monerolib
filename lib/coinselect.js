...
/**
 * @typedef {object} InputCandidate
 * @property {bigint} amount
 */

/**
 * @template {InputCandidate} T
 * @typedef {object} InputSelection
 * @property {T[]} selected
 * @property {bigint} fee
 * @property {bigint} [changeAmount]
 * @property {bigint} [sweepAmount]
 * @property {boolean} needsDummy
 */
