 ...
 *
 * @param {object} params
 * @param {{amount: bigint}[]} params.candidates - spendable candidates, unsorted
 * @param {import('./tx.js').Destination[]} params.destinations - amount can be undefined; no entry may carry isChange
