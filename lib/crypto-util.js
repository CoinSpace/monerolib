...
/**
 * Decode little-endian number and verify < n
 */
 ...
 *
 * @param {bigint} scalar - 32-byte little-endian integer
 ...
 * @returns {{ sec: bigint, pub: Uint8Array }} reduced secret scalar and public key
 */
...
export function hashToScalar(...bufs) {
  return Fn.create(decodeInt(fastHash(concatBytes(...bufs))));
}
