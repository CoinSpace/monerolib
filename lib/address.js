  ...
  return {
    ...
    decode(str) {
      ...
      for (const type of TYPES) {
        ...
        // get_account_address_from_str: the payload is exactly prefix || spend || view [|| payment id].
        // The keys are not checked as points here: every consumer decodes them and throws.
        // https://github.com/monero-project/monero/blob/v0.18.5.0/src/cryptonote_basic/cryptonote_basic_impl.cpp#L241-L246
        if (data.length !== (type === 'integratedaddress' ? 73 : 65)) {
